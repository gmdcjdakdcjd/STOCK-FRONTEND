...
export default function ResultDetailKRPage() {
    ...
    /* =========================
       ...
       ========================= */
    useEffect(() => {
        fetch(`/result/api/kr/detail?strategy=${strategy}&date=${date}`)
            .then(res => res.json())
            .then(data => {
                ...
                <div className="detail-header-card">
                    ...
                    <div className="detail-header-actions">
                        {/* <button
                            ...
                            onClick={() =>
                                navigate(`/result/listKR?strategy=${strategy}`)
                            }
                        >
                            ← 목록
                        </button> */}
                        ...
                        <tbody>
                            {rows.map(r => (
                                <tr key={r.code}>
                                    ...
                                    <td className="col-date">{r.createdAt}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
